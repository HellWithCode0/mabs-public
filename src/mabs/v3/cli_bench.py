...
def write_v4_summary(results, path: Path):
    ...
    lines = [
        ...
        "",
        "| method | d | p | shots | LER | mean_stage_ns | escalate | empty | pair | cache | clique | N_disagree |",
        "|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|",
    ]
    ...
    for r in results:
        ...
        lines.append(
            ...
            f"{_rate(r.extra, 'pair_rate')} | {_rate(r.extra, 'cache_rate')} | "
            f"{_rate(r.extra, 'clique_rate')} | {nd} |"
        )
    lines += [
        "",
        "## vs fair w3d / v3",
        "",
        "| d | p | stream_w3d | mabs_v3 (esc) | mabs_v4 (esc) | v4/w3d | LER v4 | LER batch |",
        "|---:|---:|---:|---:|---:|---:|---:|---:|",
    ]
    by = {}
    for r in results:
    ...
    for (d, p), m in sorted(by.items()):
        ...
        lines.append(
            ...
            f"{v4.mean_stage_ns:.1f} ({esc4:.3f}) | {rel:.3f} | "
